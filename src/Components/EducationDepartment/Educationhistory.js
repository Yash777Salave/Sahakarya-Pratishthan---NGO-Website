...
//                 development. It empowers individuals with the knowledge and
//                 skills necessary to navigate life’s challenges, pursue their
//                 passions, and contribute positively to their communities. Here
//                 are a few key reasons why education is vital:
//               </p>
//               <ul style={{ paddingLeft: "20px", margin: "20px 0" }}>
//                 <li>
//                   <strong>Critical Thinking and Problem-Solving Skills:</strong>{" "}
//                   Education equips people with these essential skills, enabling
//                   them to make informed decisions and advocate for themselves
//                   and others.
//                 </li>
//                 <li>
//                   <strong>Economic Development:</strong> A well-educated
//                   population drives economic growth by fostering innovation,
//                   increasing productivity, and creating job opportunities.
//                 </li>
//                 <li>
//                   <strong>Social Mobility:</strong> Education helps bridge the
//                   gap between different socioeconomic groups, promoting upward
//                   mobility and reducing inequality.
//                 </li>
//               </ul>
//               <p>
//                 At its core, education transforms lives by opening doors to
//                 opportunities, nurturing talents, and creating a better, more
//                 equitable society for all. Together, let’s ensure education for
//                 everyone.
//               </p>
//             </div>
//           </div>
      ...
      <div className="health-history-container">
        ...
        <div className="why-health-section">
          ...
          <p>
            ...
            It empowers individuals with the knowledge and skills necessary to
            navigate life’s challenges, pursue their passions, and contribute
            positively to their communities. Here are a few key reasons why
            education is vital:
          </p>
          <ul>
            <li>
              <strong>Critical Thinking and Problem-Solving Skills:</strong>{" "}
              Education equips people with these essential skills, enabling them
              to make informed decisions and advocate for themselves and others.
            </li>
            <li>
              <strong>Economic Development:</strong> A well-educated population
              drives economic growth by fostering innovation, increasing
              productivity, and creating job opportunities.
            </li>
            <li>
              <strong>Social Mobility:</strong> Education helps bridge the gap
              between different socioeconomic groups, promoting upward mobility
