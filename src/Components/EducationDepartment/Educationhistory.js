...
const Educationhistory = () => {
    ...
    const workInfoData = [
        {
            images: [education1, education2, education3,education4,education5,education6,education7,education8,education9,education10],
        ...
        {
            images: [education11, education12, education13,education14,education15,education16,education17,education18,education19,education20],
        ...
        {
            images: [education31, education32, education33,education34,education35,education36,education37,education38,education39,education40],
        ...
        {
            images: [education41,education42,education43,education44,education45,education46],
    ...
    const review = [
        {
            images: firstImage,
            name: "Pratik jagdale",
            review: "Sahkarya Pratisthan has truly transformed my life. They encouraged me to pursue my education and supported me with the essentials I needed to continue learning. Even a small amount of their help has made a huge difference in shaping my future.",
        },
        {
            images: secondImage,
            name: "Mohini Chaudhari",
            review: "I am deeply grateful to Sahkarya Pratisthan for changing my life. Their encouragement toward education and the provision of essential supplies have given me the confidence to move forward. Even the little support I receive from them has a meaningful impact on my journey.",
        },
        {
            images: thirdImage,
            name: "Nikita",
            review: "Thanks to Sahkarya Pratisthan, my life has taken a positive turn. Their motivation for me to focus on education, along with the essential supplies they provide, has made a significant difference. Even a small amount of support from them has helped me progress toward my goals.",
        },
        {
            images: fourthImage,
            name: " Mina Patil",
            review: "Sahkarya Pratisthan has been a beacon of hope in my life. Their unwavering support and encouragement have inspired me to pursue education with determination. By providing the necessary resources and essentials, they have given me the tools to grow and achieve my dreams. Even their smallest gesture of support has had a profound impact on my journey.",
        },
        {
            images: fifthImage,
            name: "Chaitali",
            review: "My life has improved significantly thanks to Sahkarya Pratisthan. They empowered me to believe in the power of education and ensured I had the resources needed to stay on track. Their thoughtful support, no matter how small, has opened doors to opportunities I never thought possible and has brought me closer to realizing my potential.",
        },
        {
            images: sixthImage,
            name: "Mayur Wankhede",
            review: "I owe a great deal of gratitude to Sahkarya Pratisthan for changing my life. They not only encouraged me to prioritize my education but also provided the essentials to support my journey. Their consistent care and even the smallest support have given me the confidence to move forward and create a brighter future for myself.",
        },
    ];
    ...
    return (
        ...
        <div className="work-section-wrapper">
            ...
            <div className="container">
                ...
                <div className="work-info" style={{backgroundColor:"#fffaf0", padding:"3rem 0rem"}}>
              
                <div className="heading1 heading05">
                    <h3>
                        <span className="stories-of">STORIES OF</span>
                        <span className="heading-font color-font5 signature-style">Events</span>
                    </h3>
                </div>
                <div className="container">
                        ...
                        <div className="row-sub-projects" key={index}>
                            ...
                            <div className="detail">
                                <div className="content">
                                    <h2 style={{textDecoration:'underline', backgroundColor:"orange"}}>{item.title}</h2>
                                    <h1>{item.text}</h1>
                                </div>
                            </div>
                        </div>
